...
pub enum Lang {
    ...
    Any,
    /// A recognizer script family (latin / cyrillic / arabic / ...) covering
    /// many spoken languages; exact languages are documented on each spec.
    Script(&'static str),
}
    ...
    pub fn ocr_specs() -> Vec<ModelSpec> {
        ...
        vec![
            ...
            ModelSpec {
                ...
                lang: Lang::Script("ja"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv4/rec/japan_PP-OCRv4_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("ja"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv4/rec/japan_PP-OCRv4_rec_mobile/japan_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                id: "rec_cht",
                role: ModelRole::Rec,
                lang: Lang::Script("zh-Hant"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv4/rec/chinese_cht_PP-OCRv3_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("zh-Hant"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv4/rec/chinese_cht_PP-OCRv3_rec_mobile/chinese_cht_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                id: "rec_latin",
                role: ModelRole::Rec,
                lang: Lang::Script("latin"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/latin_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("latin"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/latin_PP-OCRv5_rec_mobile/ppocrv5_latin_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                id: "rec_cyrillic",
                role: ModelRole::Rec,
                lang: Lang::Script("cyrillic"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/cyrillic_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("cyrillic"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/cyrillic_PP-OCRv5_rec_mobile/ppocrv5_cyrillic_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                id: "rec_arabic",
                role: ModelRole::Rec,
                lang: Lang::Script("arabic"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/arabic_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("arabic"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/arabic_PP-OCRv5_rec_mobile/ppocrv5_arabic_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                id: "rec_devanagari",
                role: ModelRole::Rec,
                lang: Lang::Script("devanagari"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/devanagari_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("devanagari"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/devanagari_PP-OCRv5_rec_mobile/ppocrv5_devanagari_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("el"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/el_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("el"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/el_PP-OCRv5_rec_mobile/ppocrv5_el_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                id: "rec_eslav",
                role: ModelRole::Rec,
                lang: Lang::Script("eslav"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/eslav_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("eslav"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/eslav_PP-OCRv5_rec_mobile/ppocrv5_eslav_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("ta"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/ta_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("ta"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/ta_PP-OCRv5_rec_mobile/ppocrv5_ta_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("te"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/te_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("te"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/te_PP-OCRv5_rec_mobile/ppocrv5_te_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("th"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv5/rec/th_PP-OCRv5_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("th"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv5/rec/th_PP-OCRv5_rec_mobile/ppocrv5_th_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("ka"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "onnx/PP-OCRv4/rec/ka_PP-OCRv4_rec_mobile.onnx",
                size_mib: 12,
                sha256: "",
                url_override: "",
            },
            ModelSpec {
                ...
                lang: Lang::Script("ka"),
                modelscope_repo: "RapidAI/RapidOCR",
                file: "paddle/PP-OCRv4/rec/kannada_PP-OCRv4_rec_mobile/ka_dict.txt",
                size_mib: 1,
                sha256: "",
                url_override: "",
            },
